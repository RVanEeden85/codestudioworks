const Services = () => {
    return (
        <section
            id="services"
            className="p-3 py-20 min-h-screen bg-[#3A6050] flex flex-col items-center justify-center relative space-y-10"
        >
            ...
            <div className="grid grid-cols-1 space-y-5 md:grid-cols-2 max-w-6xl mx-auto xl:gap-3 2xl:gap-5 z-10">
                <div className="xl:p-6 2xl:p-10 rounded-2xl flex flex-col">
                    <div className="">
                        <h2 className="font-bold xl:text-xl 2xl:text-3xl text-white/70 xl:mb-4 2xl:mb-8 text-center">
                            Branding & Visual Identity
                        </h2>
                        <div className="text-gray-300 xl:text-lg 2xl:text-xl font-medium grid grid-cols-2 gap-2">
                            <span className="rounded-lg min-h-18 xl:min-h-20 2xl:min-h-24 xl:max-h-20 2xl:max-h-24 text-center bg-white/10 flex items-center justify-center border border-white/10 px-4 py-2 shadow-md">
                                Logo Design
                            </span>
                            <span className="rounded-lg min-h-18 xl:min-h-20 2xl:min-h-24 xl:max-h-20 2xl:max-h-24 text-center bg-white/10 flex items-center justify-center border border-white/10 px-4 py-2 shadow-md">
                                Brand Guidelines
